  ...
  namespace python
  {
    ...
    void exposeArmMPC()
    {
      ...
      bp::class_<ArmMPC, boost::noncopyable>("ArmMPC", bp::no_init)
        ...
        .def("generateContactHorizon", &ArmMPC::generateContactHorizon, bp::args("self", "contact_force"))
        ...
        .def("getContactForce", &ArmMPC::getContactForce, bp::args("self", "t"))
        ...
        .def("switchToContact", &ArmMPC::switchToContact, ("self"_a, "reach_pose"))
